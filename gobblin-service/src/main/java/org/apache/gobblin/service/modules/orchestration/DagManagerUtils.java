...
public class DagManagerUtils {
  ...
  public static NewDagManager.DagId generateNewDagId(String flowGroup, String flowName, long flowExecutionId) {
    return new NewDagManager.DagId(flowGroup, flowName, flowExecutionId);
  }

  public static DagNode.DagNodeId generateDagNodeId(String flowGroup, String flowName, long flowExecutionId, String jobGroup, String jobName) {
    return new DagNode.DagNodeId(flowGroup, flowName, flowExecutionId, jobGroup, jobName);
  }

  public static DagNode.DagNodeId generateDagNodeId(JobStatusEvent jobStatusEvent) {
